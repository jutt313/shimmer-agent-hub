...
import { BarChart3, TrendingUp, Activity, Users, Zap, Settings, Bot, Clock } from 'lucide-react';
    ...
    <section className="py-20 px-6 bg-gradient-to-b from-indigo-50/40 to-blue-50/50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {/* Main Dashboard with Real Tab Structure */}
          <div className="lg:col-span-2 bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-2xl font-bold text-gray-900">YusrAI Dashboard</h3>
            ...
            {activeTab === 'services' && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>Services management interface would be shown here</p>
              </div>
            )}
            ...
            {activeTab === 'agents' && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>AI Agents monitoring and control panel</p>
              </div>
            )}
            ...
            {activeTab === 'activities' && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>Recent activities and automation logs</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
              <h4 className="font-semibold text-gray-900 mb-4">Time Savings Calculator</h4>
            ...
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
              ...
              <button 
                ...
                className="bg-white text-blue-600 px-4 py-2 rounded-xl text-sm font-semibold hover:shadow-lg transition-all"
              >
                Generate Report
              </button>
            </div>
